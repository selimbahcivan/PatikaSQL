...
-- INSERT INTO ile id name email birtday sütunlarına verileri ekledik
...
-- UPDATE ile ilk 5 ID ' yi güncelledik.
UPDATE employee SET name = 'Selim',
email = 'y.selimbahcivan@gmail.com'
WHERE id BETWEEN 1 AND 5
RETURNING *;
-- Güncellenilen verileri sildirdik.
DELETE FROM employee WHERE name = 'Selim'
RETURNING *;